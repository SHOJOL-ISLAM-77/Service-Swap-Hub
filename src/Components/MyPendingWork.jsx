                            ...
                            {services.map(service => (
                                <tr key={service._id} className="bg-white border-b hover:bg-gray-50 ">
                                    ...
                                    <td className="px-6 py-4">
                                        <select defaultValue={service.status} onChange={(e) => handleUpdateStatus(e, service._id)} id="small" className="block w-full p-2 mb-6 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500">
